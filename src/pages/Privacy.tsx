  ...
  return (
    <article className="legal-page">
      ...
      <div className="legal-body">
        ...
        <p>
          When you use our contact form, SMS opt-in form, private growth
          diagnostic, or otherwise reach out, we may collect:
        </p>
        <ul>
          <li>Name</li>
          <li>Email address</li>
          ...
          <li>Any other details you choose to share, including growth-diagnostic answers</li>
        </ul>
        <p>
